...
public class RetrospectiveRoomSeeder {
    ...
    private static final List<Question> RETRO_QUESTIONS = List.of(
            new TypeLessQuestion(-1, "What is the purpose of a Sprint Retrospective?", "To reflect and improve", "Think about learning from the Sprint."),
            new TypeLessQuestion(-1, "Who participates in the Sprint Retrospective?", "The Scrum Team", "Everyone involved in the Sprint."),
            new TypeLessQuestion(-1, "When is the Sprint Retrospective held?", "At the end of the Sprint", "Right after the Sprint Review."),
            new TypeLessQuestion(-1, "What is a common outcome of a Sprint Retrospective?", "Improvement action items", "Teams discuss what went well and what can be improved."),
            new TypeLessQuestion(-1, "How long should the Sprint Retrospective last for a one-month Sprint?", "3 hours", "Scrum Guide gives this number.")
    );
